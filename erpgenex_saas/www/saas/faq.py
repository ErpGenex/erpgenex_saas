def get_context(context):
	...
	context.faqs = [
		...
		{"q": "Which payment providers are supported?", "a": "The billing layer uses PayPal only, and payments are accepted only through the platform's configured PayPal business account."},
