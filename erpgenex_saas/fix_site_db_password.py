...
def fix_site_db_password():
    ...
    try:
        ...
        print(f"Database password from SaaS Settings: {db_password[:8]}...")
        ...
        print(f"Current DB password in config: {config.get('db_password', 'Not set')[:8]}...")
        ...
        print(f"Updated DB password in config")
        
        return True
        
    except Exception as e:
        print(f"Error fixing site DB password: {str(e)}")
        import traceback
        traceback.print_exc()
        return False
