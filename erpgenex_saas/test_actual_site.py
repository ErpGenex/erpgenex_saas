"""
Test creating actual site in sites folder with server configuration
"""

import frappe


def test_actual_site_creation():
    """Test creating actual site in sites folder"""
    
    print("=" * 60)
    print("اختبار إنشاء موقع فعلي في مجلد sites")
    print("=" * 60)
    
    try:
        # Test data
        test_data = {
            "tenant_name": "شركة النور التجارية",
            "company_email": "nour@commercial-company.com",
            "subdomain": "nour-company",
...
if __name__ == "__main__":
    result = test_actual_site_creation()
